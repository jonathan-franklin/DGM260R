...
//Name: spacehall_model_01.ma
//Last modified: Thu, Feb 02, 2017 12:48:04 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.144632844300613 5.7125530232647828 9.6413205574376999 ;
	setAttr ".r" -type "double3" -21.938352729611559 30.200000000003019 1.8400135433047031e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8B742B28-D046-46A0-E8F2-B4B6D335A21E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 17.246264275283952;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.509393991407415 1000.1 -0.88864270921114863 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.1649484803175187 -1.0863794899135919 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "DDCFA1AC-8946-BC80-E5F1-B0965DC728D6";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 23.506016484071775;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 3.9299843449276812 -5.2952622181253286 ;
...
createNode transform -n "pCube7";
	...
	setAttr ".t" -type "double3" 11.680285182622113 0 0 ;
	setAttr ".rp" -type "double3" -0.63395509119347571 3.8998440055051571 -5.547251589141073 ;
	setAttr ".sp" -type "double3" -0.63395509119347571 3.8998440055051571 -5.547251589141073 ;
...
createNode transform -n "pCube8";
	...
	setAttr ".t" -type "double3" -11.813479836516599 0 0 ;
	setAttr ".rp" -type "double3" -0.63395509119347571 3.8998440055051571 -5.547251589141073 ;
	setAttr ".sp" -type "double3" -0.63395509119347571 3.8998440055051571 -5.547251589141073 ;
...
createNode transform -n "pCube10";
	rename -uid "5F1F856C-6F4A-0947-1639-3DA55B703C7C";
	setAttr ".t" -type "double3" 8.3572396602951038 0 0 ;
	setAttr ".s" -type "double3" 9.7480551036710281 0.11111106636337691 3.574481971029793 ;
createNode mesh -n "pCubeShape10" -p "pCube10";
	rename -uid "F81E2210-464A-4996-F9B5-0EAD094C0C2B";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode mesh -n "polySurfaceShape1" -p "pCube10";
	rename -uid "0AFF305E-6D49-D225-7EBA-9D82165700E2";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "72724B84-8F49-3555-1061-A3A49C334ADC";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "C9787540-2A4B-F65A-492D-A68078201F79";
createNode displayLayer -n "defaultLayer";
	rename -uid "C3AF6724-4F44-894B-DDFD-E08D87FC3CE7";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "50D62508-AD46-56AD-0B7D-418073217AF6";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "B9302BA1-B846-718E-64C6-D7B0AFB191DE";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9050DDEB-5F40-0AB0-B46E-F48D78DAE15F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F6879956-0A45-944F-9E66-3FB5B3486988";
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".lt" -type "double3" -8.8817841970012523e-16 -9.0986450256363557e-16 0.20205998364085345 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace3";
	...
	setAttr ".lt" -type "double3" -1.8161862670939586e-15 -4.2028689944845571e-16 3.8206242042802367 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace4";
	...
	setAttr ".lt" -type "double3" 1.7763568394002505e-15 -1.483691036263687e-15 1.3180496019499142 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace5";
	...
	setAttr ".lt" -type "double3" 8.8817841970012523e-16 -8.4697381329333842e-16 0.18556905005955304 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polySplitRing -n "polySplitRing2";
	rename -uid "92BB09DB-024E-B7A7-D4D2-76959F36B90E";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 2 "e[6:7]" "e[10:11]";
	setAttr ".ix" -type "matrix" 9.7480551036710281 0 0 0 0 0.11111106636337691 0 0 0 0 3.574481971029793 0
		 8.3572396602951038 0 0 1;
	setAttr ".wt" 0.27458876371383667;
	setAttr ".re" 7;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
	setAttr ".fq" yes;
createNode polySplitRing -n "polySplitRing3";
	rename -uid "28BDB4AA-E548-77F6-776E-8EA82A004528";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[10:13]";
	setAttr ".ix" -type "matrix" 9.7480551036710281 0 0 0 0 0.11111106636337691 0 0 0 0 3.574481971029793 0
		 8.3572396602951038 0 0 1;
	setAttr ".wt" 0.59343522787094116;
	setAttr ".dr" no;
	setAttr ".re" 12;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
...
createNode polySplit -n "polySplit1";
	rename -uid "1DEB8F29-494D-649E-83BB-06B75679B47B";
	setAttr -s 2 ".e[0:1]"  0.891352 0.891352;
	setAttr -s 2 ".d[0:1]"  -2147483626 -2147483634;
	setAttr ".sma" 180;
	setAttr ".m2015" yes;
createNode polySplit -n "polySplit2";
	rename -uid "D0B32AB3-CD4A-CE08-B548-B89F22ABDDAD";
	setAttr -s 2 ".e[0:1]"  0.97484601 0.97484601;
...
connectAttr "polySplit2.out" "pCubeShape10.i";
