...
//Name: PropOne.ma
//Last modified: Mon, Jan 30, 2017 01:03:33 AM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.0084204206354315 20.121478990263775 3.2068360743374882 ;
	setAttr ".r" -type "double3" -38.738352722909937 1787.7999999962931 -8.1351109085224211e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A3450A50-44DF-94AB-9EB2-E586B78727AA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.8924397435805416;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 1.0966789722442627 18.508171081542969 0.00020213425159454346 ;
...
createNode mesh -n "pCube3Shape" -p "transform3";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt[116:119]" -type "float3"  -6.2237275e-005 -0.99589491 
		0 -0.0010590216 -0.9894855 0 -6.2237275e-005 -0.99589491 0 0.0010593026 -1.0031077 
		0;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FD7E9890-41EA-AB4B-DD7E-9AB83240B448";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1C3E4FFD-45C6-E079-0F0D-2198C4ACCC8B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1212B8A7-40B3-222B-8EA5-D4810F343792";
createNode displayLayerManager -n "layerManager";
	rename -uid "AD52219A-4545-1D98-7C0B-EDA7D1850E7E";
createNode displayLayer -n "defaultLayer";
	rename -uid "3818BC25-4CBA-BE55-A0BA-DDB0EFDDC589";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "47671D36-41FB-0083-7F0A-C5980B8D9968";
...
createNode polyTweak -n "polyTweak13";
	...
	setAttr ".uopa" yes;
	setAttr ".tk[102]" -type "float3"  -0.31609318 -3.12937593 0;
...
createNode polyTweak -n "polyTweak15";
	...
	setAttr ".uopa" yes;
	setAttr -s 60 ".tk[432:491]" -type "float3"  0.23167232 0.012344724 0.31530097
		 0.31944737 0.012344724 0.22828323 0.24295884 -0.0085469279 0.32363907 0.32494578
		 -0.0085469279 0.23953754 0.34817466 0.012344724 0.17981632 0.35777301 -0.0085469279
		 0.18176155 0.17808558 0.012344724 0.34209442 0.18571407 -0.0085469279 0.35798594
		 0.18571407 0.012344724 0.35798597 0.24295884 0.012344724 0.32363898 0.32494584 0.012344724
		 0.23953757 0.35777301 0.012344724 0.18176155 0.39076376 0.012837074 -0.043840639
		 0.37392193 0.012837074 -0.11622923 0.4019877 -0.0080545777 -0.046391096 0.38599584
		 -0.0080545777 -0.12159529 0.32023206 0.012837074 -0.223609 0.32965156 -0.0080545777
		 -0.23025945 0.27558094 0.012837074 -0.26825076 0.2826311 -0.0080545777 -0.27530098
		 0.4019877 0.012837074 -0.046391096 0.38599584 0.012837074 -0.1215953 0.32965153 0.012837074
		 -0.23025942 0.28263113 0.012837074 -0.27530095 0.059443396 0.01226901 -0.37673151
		 0.0014128799 0.01226901 -0.38506487 0.066021018 -0.0086226417 -0.39061406 0.0025977031
		 -0.0086226417 -0.39630023 -0.11713224 0.012328481 -0.36651918 -0.12855543 -0.008622665
		 -0.37824738 -0.17103548 0.01226901 -0.33890861 -0.18194871 -0.0086226417 -0.34821364
		 0.066021018 0.01226901 -0.39061406 0.0025977031 0.01226901 -0.39630026 -0.12855545
		 0.012268987 -0.37824738 -0.18194871 0.01226901 -0.3482137 -0.34133595 0.013262381
		 -0.17076631 -0.37144008 0.013262389 -0.11557364 -0.35393977 -0.0043227207 -0.1782122
		 -0.38014975 -0.0043227104 -0.11530874 -0.3894169 0.013262374 0.0017748569 -0.39902046
		 -0.0043227216 0.00630379 -0.37999389 0.013262385 0.058699768 -0.39356202 -0.0043227021
		 0.072233401 -0.35599768 0.013262625 -0.17971112 -0.38059112 0.01326263 -0.11412701
		 -0.39903751 0.013262616 0.0069885845 -0.39024711 0.013262628 0.067489408 -0.27205503
		 0.013432685 0.27764139 -0.22558346 0.013432685 0.31747431 -0.28002158 -0.0074589662
		 0.28029686 -0.23487768 -0.0074589662 0.3267684 -0.1215581 0.013432685 0.37235743
		 -0.11405138 -0.0074589662 0.3878454 -0.062379897 0.013432685 0.37944135 -0.054302193
		 -0.0074589662 0.39448422 -0.28002158 0.013432685 0.2802968 -0.23487768 0.013432685
		 0.32676834 -0.11405138 0.013432685 0.3878454 -0.054302193 0.013432685 0.39448416;
...
createNode polyTweak -n "polyTweak22";
	rename -uid "0C24F7E7-4784-CD4A-4B5F-DA8378D23BA7";
	setAttr ".uopa" yes;
	setAttr -s 40 ".tk[940:979]" -type "float3"  0.0016814172 0 -0.0012356181
...
createNode polySplit -n "polySplit15";
	rename -uid "3B0836E2-4748-082B-11D0-18974DEA65E7";
	setAttr -s 2 ".e[0:1]"  1 0;
	setAttr -s 2 ".d[0:1]"  -2147482229 -2147482246;
	setAttr ".sma" 180;
	setAttr ".m2015" yes;
createNode polySplit -n "polySplit16";
	rename -uid "C4B779CC-438E-A95D-7788-2B9408AABA87";
	setAttr -s 2 ".e[0:1]"  1 0;
	setAttr -s 2 ".d[0:1]"  -2147482233 -2147482235;
	setAttr ".sma" 180;
	setAttr ".m2015" yes;
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "polySplit16.out" "pCylinder4Shape.i";
